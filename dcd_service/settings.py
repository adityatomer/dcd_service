"""
Django settings for dcd_service project.
...
SECRET_KEY = 'w0e(^==xy*+d-%+4d*&ufd7c8=69b_r3-zuqq!1bo1ck4jt-m%'
...
WSGI_APPLICATION = 'dcd_service.wsgi.application'
